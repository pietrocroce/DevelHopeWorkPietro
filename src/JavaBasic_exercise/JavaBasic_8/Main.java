package JavaBasic_exercise.JavaBasic_8;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        //trasformato il valore della stringa in un numero intero
        int ourNumberInTheStr = Integer.valueOf(ourNumberStr);
        ourNumberInTheStr += 2;
        System.out.println(ourNumberInTheStr);
        //ritrasformare il valore int in una stringa
        String ChangeInAString = String.valueOf(ourNumberInTheStr);
        //riconvertita in una stringa,appena facciamo la somma rivedremo una concatenazione anzichè una somma
        System.out.println(ChangeInAString + 2);    //test per confermare fosse una stringa
    }
    ...
    private static void exercise2() {
        ...
        int charAtIndex = 5; // <--- Change this line
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "8.8"; // Also this line
    ...
    private static void exercise4() {
        ...
        int number = Integer.valueOf(startStr.trim());
        number = number * 2;
        System.out.println(number);

        String finishString = String.valueOf(number);
        finishString +=10;
        System.out.println(finishString);

        double StringInDouble = Double.valueOf(finishString) / 3.5;
        System.out.println(Math.floor(StringInDouble));
    }
}
