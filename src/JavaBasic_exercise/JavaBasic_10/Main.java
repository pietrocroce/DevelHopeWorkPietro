package JavaBasic_exercise.JavaBasic_10;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        if(shoeType.equals(true) && (eurosInPocket > eurosForEntry) && age>18){
    ...
    private static void exercise3() {
        ...
        if(ourTestScore == (90*maxTestScore/100)){
            System.out.println("A");
        }else if (ourTestScore == (80*maxTestScore/100)){
            System.out.println("B");
        }else if (ourTestScore == (70*maxTestScore/100)){
            System.out.println("C");
        }else if (ourTestScore == (60*maxTestScore/100)){
            System.out.println("D");
        }else if (ourTestScore < 60){
            System.out.println("F");
        }else if (isTestRetry == true){
            System.out.println("C");
        }else {
            System.out.println("Change school, is not for you");
        }
    }
