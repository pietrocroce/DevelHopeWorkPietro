package JavaBasic_exercise.JavaBasic_14;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        int sumForA = 0;
        for (Integer items : itemsA){
            sumForA += items;
        }
            System.out.println("the sum of items A is ="+ sumForA);
        ...
        for (int items1 : itemsB){
            sumForB += items1;
        }
        System.out.println("the sum of items A is ="+ sumForB);
        System.out.println("\nExercise 1c:");
    ...
    private static void exercise2() {
        ...
        System.out.println("il minimo è= "+ minNumber+ ", il più grande è = "+ maxNumber);
    }
    ...
    private static void exercise5() {
        ...
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            System.out.println("*****timesTableNumber****"+ timesTableNumber);
            for (
