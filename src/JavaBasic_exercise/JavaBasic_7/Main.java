package JavaBasic_exercise.JavaBasic_7;
...
public class Main {
   ...
   private static void exercise2() {
      ...
      String middleName = "Paolo";
      String lastName = "Croce";
   ...
   private static void exercise3() {
      System.out.println("\nExercise 3:");
      String ExperimentWithIntAndDouble = "67";
      ExperimentWithIntAndDouble += 1.5;
      String ExperimentWithBooleanAndInt = "true";
      ExperimentWithBooleanAndInt += 5;
      char MyNamestart = 'P';
      char MySurnameStart = 'C';
      String textFrom2Primitives = "My name start with the letters "+ MyNamestart + "-" + MySurnameStart;
      // <--- Edit this line
      System.out.println(textFrom2Primitives);
      //Non mi stamperà una somma ma farà una concatenazione di stringhe con risultato 671.5
      System.out.println(ExperimentWithIntAndDouble);
      System.out.println("Is it true my lunch cost 5 euro? =" + ExperimentWithBooleanAndInt);
   }
